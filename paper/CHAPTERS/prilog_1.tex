...
\begin{figure}
  \centering
  \includegraphics[width=0.7\textwidth]{Slike/SlikaCitat.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{Dijagrami/SlikaCitat3.eps}
...
\begin{landscape}
  \begin{figure}
    \centering
    \includegraphics[width=25cm]{Slike/SlikaCitat2.jpg}
...
Primjeri navođenja literature su knjiga \cite{Hajn01}, poglavlje u knjizi \cite{Samp05}, članak objavljen u časopisu \cite{nesterov1983method}, članak objavljen na konferenciji \cite{Wirt99}, doktorski rad \cite{Will93}, Internetski izvor \cite{Jone12} te različite druge publikacije \cite{Rsoft}. Stil navođenja literature temelji se na stilu razvijenom za IEEE časopise i konferencije.
