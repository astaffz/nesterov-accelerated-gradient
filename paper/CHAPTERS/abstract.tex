...
U ovom radu ćemo se baviti metodom za nalaženje minimuma funkcije, zasnovanu na Nesterovljevom ubrzanom gradijentnom. Na početku rada ćemo se osvrnuti na teoretsku pozadinu navedenog algoritma, područija na kojima je najprimjenjeniji. Sljedeće čime ćemo se baviti je implementacijom navedenog algoritma u Julia programskom jeziku, ćiju ćemo korektnost testirati ručno na nekim proizvoljnim funkcijama, kao i na Rosenbrockovoj funkciji. U zaključku ćemo se osvrnuti na to koliko je naša implementacija algoritma dobra I može li se iskoristiti za svrhe u kojima se ovaj algoritam najviše koristi.
...
\fi
\vspace{1cm}
\textbf{Keywords}: Nesterov accelerated gradient, numerical optimization, convex optimization, deep learning, FISTA, momentum, first-order methods, Julia
