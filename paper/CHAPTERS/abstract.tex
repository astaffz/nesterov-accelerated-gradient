...
Nesterovljev ubrzani gradijentni metod za minimizaciju koju valja obraditi pa makar. Interesantna je, iterativna je, podsjeća na IF1.
...
\vspace{1cm}
\textbf{Ključne riječi}: Nesterovljev ubrzani gradijentni, minimizacija, IF1 %predložak, \LaTeX, ETF

\section*{Abstract}

Nester's acelerated gradient method for minimization needs to be covered, or else. It is interesting, iterative proccess, it reminds us on IF1. 
...
\vspace{1cm}
\textbf{Keywords}:  Nester's acelerated gradient, minimization, IF1 %template, \LaTeX, ETF
