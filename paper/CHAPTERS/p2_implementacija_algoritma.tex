\lstdefinelanguage{Julia}{
    ...
    morekeywords     = {function, end, for, if, else, elseif, return,
            in, while, break, continue, using, import,
            export, module, struct, mutable, abstract,
            type, where, let, do, try, catch, finally,
            true, false, nothing, begin, local, global},
    morecomment      = [l]{\#},
    morestring       = [b]",
    sensitive        = true,
}
...
Trideset godina nakon Nesterovljeve publikacije, Sutskever i koautori~\cite{sutskever2013}
...
% ─────────────────────────────────────────────────────────────────────────────
\section{Bengiova formulacija metode (BNAG)}
...
naglašene aproksimacije i ograničenja tamo gdje postoje. U narednom poglavlju slijedi komparativna
analiza dobijenih rezultata, diskusija prednosti i nedostataka svakog pristupa, te poređenje sa
rezultatima iz relevantne literature.