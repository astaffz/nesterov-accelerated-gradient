...
\begin{figure}[htbp]
    ...
    \caption{Graf nivo-linija Rosenbrockove funkcije sa označenim globalnim minimumom $f(1,1)=0$.}
...
\begin{figure}[H]
    ...
    \caption{Putanje konvergencije sve tri formulacije NAG metode na Rosenbrockovoj funkciji.
...
pojedinim iteracijama, no ipak uspijeva konvergirati u broju koraka približnom broju koraka klasične formulacije.
