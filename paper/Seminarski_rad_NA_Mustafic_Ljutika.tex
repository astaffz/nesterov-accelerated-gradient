...
%\usepackage{listings-julia}



\definecolor{juliaBlue}{RGB}{0, 102, 204}
\definecolor{juliaGreen}{RGB}{0, 153, 0}
\definecolor{juliaGray}{RGB}{128,128,128}
\definecolor{juliaPurple}{RGB}{153,0,153}

\lstdefinelanguage{Julia}{
  keywords={
    function,end,if,else,elseif,while,for,begin,return,
    break,continue,struct,mutable,import,export,using,
    try,catch,finally,global,local,const,do,where,module
  },
...
\lstset{
  ...
  numbers=left,
  numberstyle=\tiny\color{juliaGray},
  breaklines=true,
  frame=single,
...
%Poglavlje 1
\input{CHAPTERS/p1_uvod}
%Poglavlje 2
\input{CHAPTERS/p2_implementacija_algoritma}
%Poglavlje 3
\input{CHAPTERS/p3_primjene_algoritma}
%Poglavlje 4
\input{CHAPTERS/p4_zakljucak}
